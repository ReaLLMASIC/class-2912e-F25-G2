...
//         // ... inside CAPTURE state ...
        
//         // if frame is requested, read pixel from regfile to output
//         // else if (req_frame) begin
//         //     // 1. Release Buffer Reset
//         //     if(~readout_buffer_rst_n) begin
//         //         readout_buffer_rst_n <= 1'b1;
//         //     end

//         //     // ---------------------------------------------------------
//         //     // PIPELINE STAGE 1: Request Data (Address)
//         //     // ---------------------------------------------------------
//         //     if (reg_current_pixel_index < TOTAL_PIXELS) begin
//         //         reg_rd_enable <= 1'b1;
//         //         reg_rd_addr <= reg_current_pixel_index;
//         //     end 
//         //     else begin
//         //         reg_rd_enable <= 1'b0; // Stop reading when we hit max address
//         //     end

//         //     // ---------------------------------------------------------
//         //     // PIPELINE STAGE 2 & 3: Latch Data (Internal)
//         //     // ---------------------------------------------------------
//         //     // Capture RegFile output into local register
//         //     readout_mem_in <= reg_out; 
...
//         //     // ---------------------------------------------------------
//         //     // PIPELINE STAGE 4: Output Gating (Crucial Fix)
//         //     // ---------------------------------------------------------
//         //     // Wait 4 cycles for the pipeline to fill.
//         //     // If we are before cycle 4, output 0. 
//         //     // If we are at cycle 4 or later, output the buffer.
//         //     if (reg_current_pixel_index >= 4) begin 
//         //         frame_data_out <= readout_buffered_out;
//         //     end 
//         //     else begin
//         //         frame_data_out <= {N{1'b0}}; // Mask output to 0 while filling pipe
//         //     end

//         //     // ---------------------------------------------------------
//         //     // COUNTER & TERMINATION
//         //     // ---------------------------------------------------------
//         //     // Run counter longer (TOTAL + 6) to flush the 4-stage pipeline completely
//         //     // plus a safety margin to ensure the last pixel exits.
//         //     if (reg_current_pixel_index < TOTAL_PIXELS + 6) begin
//         //         reg_current_pixel_index <= reg_current_pixel_index + 1;
//         //     end
//         //     else begin 
//         //         // Cleanup
...
//         //         regfile_rst_n <= 1'b0;
//         //         readout_buffer_rst_n <= 1'b0;
//         //         frame_data_out <= {N{1'b0}}; // Reset output to 0
//         //     end
//         // end
